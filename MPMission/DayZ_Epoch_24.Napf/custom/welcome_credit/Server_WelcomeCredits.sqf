...
_role1 = "Welcome to";
_role1names = ["Survive Th3 Dead PVE Server", "Dayz Epoch Napf"];
_role2 = "Rules";
_role2names = ["Server for Newbies - New Players", "If you are pro then lets help others", "No Hack-Cheat-Script-DDOS anytime"];
